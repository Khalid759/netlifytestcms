...
function Testimonial5() {
  ...
  return (
    <div className="alumni-testi5-wrap">
      <div className="alumni-testi5-heroSlider-fixed">
        <Slider {...settings}>
          {reviewData.map((info, key) => (
            <div className="alumni-testi5-wrap-card" key={key}>
              ...
              <div className="alumni-testi5-slick-card" key={key}>
                <p className="alumni-testi5-slick-card-heading">{info.title}</p>
                <p className="alumni-testi5-slick-card-program">
                  {info.program}
                </p>
                <p className="alumni-testi5-slick-card-desc">
                  <ReadMoreModal
                    id={info.id}
                    readModal={readModal}
