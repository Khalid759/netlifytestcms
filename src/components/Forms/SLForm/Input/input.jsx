  ...
  return (
    <React.Fragment>
      ...
      {isRequired && btnClicked && type === "text" && !value && (
        <p className="sl-error-msg">can't be blank</p>
      )}
      {isRequired && btnClicked && type === "email" && !validEmail && (
        <p className="sl-error-msg">must be a valid email</p>
      )}
      {isRequired && btnClicked && type === "tel" && !validPhone && (
        <p className="sl-error-msg">must be of 10 digits</p>
      )}
      {isRequired && btnClicked && type === "url" && !validUrl && (
        <p className="sl-error-msg">
