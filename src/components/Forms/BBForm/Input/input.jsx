  ...
  return (
    <React.Fragment>
      ...
      {isRequired && btnClicked && type === "text" && !value && (
        <p className="bb-error-msg">can't be blank</p>
      )}
      {isRequired && btnClicked && type === "email" && !validEmail && (
        <p className="bb-error-msg">must be a valid email</p>
      )}
      {isRequired && btnClicked && type === "tel" && !validPhone && (
        <p className="bb-error-msg">must be of 10 digits</p>
      )}
      {isRequired && btnClicked && type === "url" && !validUrl && (
        <p className="bb-error-msg">
