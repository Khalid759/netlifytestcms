  ...
  return (
    <React.Fragment>
      ...
      {btnClicked && type === "text" && !value && (
        <p className="wwuan-error-msg">can't be blank</p>
      )}
      {btnClicked && type === "email" && !validEmail && (
        <p className="wwuan-error-msg">must be a valid email</p>
      )}
      {btnClicked && type === "tel" && !validPhone && (
        <p className="wwuan-error-msg">must be of 10 digits</p>
      )}
      {btnClicked && type === "url" && !validUrl && (
        <p className="wwuan-error-msg">
          can't be blank, must be a valid profile link
        </p>
      )}
      {btnClicked && type === "file" && !validFile && (
        <p className="wwuan-error-msg">
